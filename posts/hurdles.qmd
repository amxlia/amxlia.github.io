...
- Ran univariate models first to find potential covariates for each outcome 
- Ran multivariable models that included all predictors and significant covariates from the univariate models 
- Ran for each outcome:
  - alcohol use x psychological distress interaction model 
  - other drug use x psychological distress interaction model 
